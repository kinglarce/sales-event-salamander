...
-- Final aggregation grouped by shop_category
SELECT 
    shop_category,
    category AS ticket_group,
    ...
    MIN(tc.id) AS capacity_config_id  -- Include this for ordering
FROM (
    -- Singles and Doubles
    SELECT 
        shop_category, 
...
GROUP BY shop_category, category
ORDER BY shop_category, capacity_config_id NULLS LAST, category; 